...
public class QuoteProductsRecyclerAdapter extends RecyclerView.Adapter<QuoteProductsRecyclerAdapter.ViewHolder> {
    ...
    public QuoteProductsRecyclerAdapter(Context context, ArrayList<CrmEntities.AccountProducts.AccountProduct> data) {
