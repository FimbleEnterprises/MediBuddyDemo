...
public class PdfTools {
    ...
    public static void manipulatePdf() throws Exception {
        PdfDocument pdfDoc = new PdfDocument(new PdfWriter(Helpers.Files.AttachmentTempFiles.getDirectory() + File.separator + "fuckyou.pdf"));
