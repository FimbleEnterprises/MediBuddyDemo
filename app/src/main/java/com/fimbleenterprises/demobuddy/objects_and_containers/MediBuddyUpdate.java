...
import static com.fimbleenterprises.demobuddy.MyPreferencesHelper.MEDIBUDDY_UPDATE_JSON;
...
public class MediBuddyUpdate {
    ...
    public MediBuddyUpdate(JSONObject json) {
        ...
        this.json = json.toString();
            ...
            try {
                if (!json.isNull("msus_is_demo")) {
                    this.isDemo = (json.getBoolean("msus_is_demo"));
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
