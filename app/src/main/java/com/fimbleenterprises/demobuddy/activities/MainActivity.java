...
import com.fimbleenterprises.demobuddy.MileBuddyUpdater;
...
import com.fimbleenterprises.demobuddy.UpdateDownloader;
...
import com.fimbleenterprises.demobuddy.services.MyFirebaseMessagingService;
...
import com.fimbleenterprises.demobuddy.dialogs.MyRatingDialog;
import com.fimbleenterprises.demobuddy.dialogs.MyTwoChoiceDialog;
import com.fimbleenterprises.demobuddy.activities.fullscreen_pickers.FullscreenAccountTerritoryPicker;
...
import com.fimbleenterprises.demobuddy.activities.ui.drawer.mileage.MileageFragment;
import com.fimbleenterprises.demobuddy.activities.ui.drawer.settings.SettingsActivity;
...
import static com.fimbleenterprises.demobuddy.QueryFactory.*;
import static com.fimbleenterprises.demobuddy.activities.ui.drawer.mileage.MileageFragment.PERMISSION_UPDATE;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DrawerLayout.DrawerListener {
    ...
    protected void getDistinctUsersWithTrips() {
        ...
        linkEntity.addColumn(new EntityColumn("nickname"));
        ...
        if (users == null || users.size() < 1) {
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < users.size(); i++) {
                            ...
                            if (user.isDriving()) {
                                subMenu.add(0, i, i, getString(R.string.is_driving, user.fullname))
                                        .setIcon(R.drawable.notification_small_car);
                            } else {
                                subMenu.add(0, i, i, options.isExplicitMode() ? user
                                        .fullFuckingName() : user.fullname).setIcon(R.drawable.arrow_right2);
                            }
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
            ...
            for (int i = 0; i < users.size(); i++) {
                ...
                if (user.isDriving()) {
                    ...
                    subMenu.add(0, i, i, options.isExplicitMode() ? user.fullname : user.fullname).setIcon(R.drawable.arrow_right2);
                }
            }
